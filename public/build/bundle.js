...
var app = (function () {
    ...
    var areaStream$1 = {
      ...
      polygonEnd: function() {
        ...
        areaSum$1.add(areaRing < 0 ? tau$5 + areaRing : areaRing);
    ...
    var boundsStream$2 = {
      ...
      polygonEnd: function() {
        ...
        else if (deltaSum > epsilon$6) phi1 = 90;
        else if (deltaSum < -epsilon$6) phi0 = -90;
    ...
    function boundsRingEnd() {
      ...
      if (abs$3(deltaSum) > epsilon$6) lambda0$1 = -(lambda1 = 180);
      range$1[0] = lambda0$1, range$1[1] = lambda1;
      p0 = null;
    }
    ...
    function centroid$1(object) {
      ...
      if (m < epsilon2$1) {
        ...
        if (W1 < epsilon$6) x = X0$1, y = Y0$1, z = Z0$1;
        m = hypot(x, y, z);
    ...
    function rotationIdentity(lambda, phi) {
      if (abs$3(lambda) > pi$4) lambda -= Math.round(lambda / tau$5) * tau$5;
      return [lambda, phi];
    }
    ...
    function circleRadius(cosRadius, point) {
      ...
      return ((-point[2] < 0 ? -radius : radius) + tau$5 - epsilon$6) % tau$5;
    }

    function circle$1() {
      var center = constant$a([0, 0]),
          radius = constant$a(90),
          precision = constant$a(2),
          ring,
          rotate,
          stream = {point: point};
    ...
    function pointEqual(a, b) {
      return abs$3(a[0] - b[0]) < epsilon$6 && abs$3(a[1] - b[1]) < epsilon$6;
    }
    ...
    function longitude(point) {
      return abs$3(point[0]) <= pi$4 ? point[0] : sign$1(point[0]) * ((abs$3(point[0]) + pi$4) % tau$5 - pi$4);
    }
    ...
    function polygonContains(polygon, point) {
      ...
      if (sinPhi === 1) phi = halfPi$3 + epsilon$6;
      else if (sinPhi === -1) phi = -halfPi$3 - epsilon$6;
      ...
      for (var i = 0, n = polygon.length; i < n; ++i) {
        ...
        for (var j = 0; j < m; ++j, lambda0 = lambda1, sinPhi0 = sinPhi1, cosPhi0 = cosPhi1, point0 = point1) {
          ...
          angle += antimeridian ? delta + sign * tau$5 : delta;
      ...
      return (angle < -epsilon$6 || angle < epsilon$6 && sum < -epsilon2$1) ^ (winding & 1);
    }
    ...
    function compareIntersection(a, b) {
      return ((a = a.x)[0] < 0 ? a[1] - halfPi$3 - epsilon$6 : halfPi$3 - a[1])
           - ((b = b.x)[0] < 0 ? b[1] - halfPi$3 - epsilon$6 : halfPi$3 - b[1]);
    }
    ...
    function clipAntimeridianLine(stream) {
      ...
      return {
        ...
        point: function(lambda1, phi1) {
          ...
          if (abs$3(delta - pi$4) < epsilon$6) { // line crosses a pole
            ...
            if (abs$3(lambda0 - sign0) < epsilon$6) lambda0 -= sign0 * epsilon$6; // handle degeneracies
            if (abs$3(lambda1 - sign1) < epsilon$6) lambda1 -= sign1 * epsilon$6;
    ...
    function clipAntimeridianIntersect(lambda0, phi0, lambda1, phi1) {
      ...
      return abs$3(sinLambda0Lambda1) > epsilon$6
    ...
    function clipAntimeridianInterpolate(from, to, direction, stream) {
      ...
      if (from == null) {
        ...
        stream.point(-pi$4, 0);
        stream.point(-pi$4, phi);
      } else if (abs$3(from[0] - to[0]) > epsilon$6) {
    ...
    function clipCircle(radius) {
      var cr = cos$2(radius),
          delta = 2 * radians$1,
          smallRadius = cr > 0,
          notHemisphere = abs$3(cr) > epsilon$6; // TODO optimise for this common case
      ...
      function intersect(a, b, two) {
        ...
        var delta = lambda1 - lambda0,
            polar = abs$3(delta - pi$4) < epsilon$6,
            meridian = polar || delta < epsilon$6;
        ...
        if (meridian
            ? polar
              ? phi0 + phi1 > 0 ^ q[1] < (abs$3(q[0] - lambda0) < epsilon$6 ? phi0 : phi1)
              : phi0 <= q[1] && q[1] <= phi1
    ...
    function clipRectangle(x0, y0, x1, y1) {
      ...
      function corner(p, direction) {
        return abs$3(p[0] - x0) < epsilon$6 ? direction > 0 ? 0 : 3
            : abs$3(p[0] - x1) < epsilon$6 ? direction > 0 ? 2 : 1
            : abs$3(p[1] - y0) < epsilon$6 ? direction > 0 ? 1 : 0
    ...
    function graticuleX(y0, y1, dy) {
      var y = range$2(y0, y1 - epsilon$6, dy).concat(y1);
      return function(x) { return y.map(function(y) { return [x, y]; }); };
    }

    function graticuleY(x0, x1, dx) {
      var x = range$2(x0, x1 - epsilon$6, dx).concat(x1);
    ...
    function graticule() {
      ...
      function lines() {
        return range$2(ceil(X0 / DX) * DX, X1, DX).map(X)
            ...
            .concat(range$2(ceil(x0 / dx) * dx, x1, dx).filter(function(x) { return abs$3(x % DX) > epsilon$6; }).map(x))
            .concat(range$2(ceil(y0 / dy) * dy, y1, dy).filter(function(y) { return abs$3(y % DY) > epsilon$6; }).map(y));
      }
      ...
      return graticule
          .extentMajor([[-180, -90 + epsilon$6], [180, 90 - epsilon$6]])
          .extentMinor([[-180, -80 - epsilon$6], [180, 80 + epsilon$6]]);
    }
    ...
    function interpolate$2(a, b) {
      ...
      var interpolate = d ? function(t) {
        ...
        return [
          ...
          atan2$1(z, sqrt$2(x * x + y * y)) * degrees$2
        ];
      } : function() {
      ...
      function resampleLineTo(x0, y0, lambda0, a0, b0, c0, x1, y1, lambda1, a1, b1, c1, depth, stream) {
        ...
        if (d2 > 4 * delta2 && depth--) {
          var a = a0 + a1,
              ...
              phi2 = asin$1(c /= m),
              lambda2 = abs$3(abs$3(c) - 1) < epsilon$6 || abs$3(lambda0 - lambda1) < epsilon$6 ? (lambda0 + lambda1) / 2 : atan2$1(b, a),
    ...
    function conicEqualAreaRaw(y0, y1) {
      ...
      if (abs$3(n) < epsilon$6) return cylindricalEqualAreaRaw(y0);
    ...
    function albersUsa() {
      ...
      albersUsa.translate = function(_) {
        ...
        alaskaPoint = alaska
            ...
            .clipExtent([[x - 0.425 * k + epsilon$6, y + 0.120 * k + epsilon$6], [x - 0.214 * k - epsilon$6, y + 0.234 * k - epsilon$6]])
            .stream(pointStream);

        hawaiiPoint = hawaii
            .translate([x - 0.205 * k, y + 0.212 * k])
            .clipExtent([[x - 0.214 * k + epsilon$6, y + 0.166 * k + epsilon$6], [x - 0.115 * k - epsilon$6, y + 0.234 * k - epsilon$6]])
            .stream(pointStream);
    ...
    function conicConformalRaw(y0, y1) {
      ...
      function project(x, y) {
        if (f > 0) { if (y < -halfPi$3 + epsilon$6) y = -halfPi$3 + epsilon$6; }
        else { if (y > halfPi$3 - epsilon$6) y = halfPi$3 - epsilon$6; }
    ...
    function conicEquidistantRaw(y0, y1) {
      ...
      if (abs$3(n) < epsilon$6) return equirectangularRaw;
    ...
    naturalEarth1Raw.invert = function(x, y) {
      ...
      } while (abs$3(delta) > epsilon$6 && --i > 0);
      return [
    	...
    	subunits: {
    		...
    		geometries: [
    			...
    			},
    			{
    				...
    				properties: {
    					name: "Los Angeles",
    					fullName: "Los Angeles County",
    					areaLand: 10510365728
    				},
    				arcs: [
    					[
    						[
    			...
    			},
    			{
    				...
    				properties: {
    					name: "San Diego",
    					fullName: "San Diego County",
    					areaLand: 10895213672
    				},
    				arcs: [
    					[
    						116,
    			...
    			},
    			{
    				...
    				properties: {
    					name: "Lassen",
    					fullName: "Lassen County",
    					areaLand: 11761622251
    				},
    				arcs: [
    					[
    						165,
    			...
    			},
    			{
    				...
    				properties: {
    					name: "Inyo",
    					fullName: "Inyo County",
    					areaLand: 26368506526
    				},
    				arcs: [
    					[
    						273,
    			...
    			},
    			{
    				...
    				properties: {
    					name: "San Bernardino",
    					fullName: "San Bernardino County",
    					areaLand: 51947497395
    				},
    				arcs: [
    					[
    						306,
    			...
    			},
    			{
    				...
    				properties: {
    					name: "Riverside",
    					fullName: "Riverside County",
    					areaLand: 18664548548
    				},
    				arcs: [
    					[
    						-313,
    			...
    			},
    			{
    				...
    				properties: {
    					name: "Kern",
    					fullName: "Kern County",
    					areaLand: 21061724395
    				},
    				arcs: [
    					[
    						-113,
    			...
    			},
    			{
    				...
    				properties: {
    					name: "Modoc",
    					fullName: "Modoc County",
    					areaLand: 10140841147
    				},
    				arcs: [
    					[
    						388,
    			...
    			},
    			{
    				...
    				properties: {
    					name: "Fresno",
    					fullName: "Fresno County",
    					areaLand: 15433281588
    				},
    				arcs: [
    					[
    						-288,
    			...
    			},
    			{
    				...
    				properties: {
    					name: "Tulare",
    					fullName: "Tulare County",
    					areaLand: 12494776168
    				},
    				arcs: [
    					[
    						-112,
    			...
    			},
    			{
    				...
    				properties: {
    					name: "Imperial",
    					fullName: "Imperial County",
    					areaLand: 10817387422
    				},
    				arcs: [
    					[
    						-119,
    			...
    			},
    			{
    				...
    				properties: {
    					name: "Siskiyou",
    					fullName: "Siskiyou County",
    					areaLand: 16259635719
    				},
    				arcs: [
    					[
    						-390,
    			...
    			},
    			{
    				...
    				properties: {
    					...
    					fullName: "San Luis Obispo County",
    					areaLand: 8543720566
    				},
    				arcs: [
    					[
    ...
    var transform$1 = {
    	scale: [
    		0.0010351827182718282,
    		0.0009481633163316333
    	],
    	translate: [
    		-124.482003,
    		32.528832
    ...
    const {abs: abs$2, max: max$2, min: min$1} = Math;
    ...
    function ribbon(headRadius) {
      ...
      function ribbon() {
        ...
        if (ap > epsilon$4) {
          if (abs$1(sa1 - sa0) > ap * 2 + epsilon$4) sa1 > sa0 ? (sa0 += ap, sa1 -= ap) : (sa0 -= ap, sa1 += ap);
          else sa0 = sa1 = (sa0 + sa1) / 2;
          if (abs$1(ta1 - ta0) > ap * 2 + epsilon$4) ta1 > ta0 ? (ta0 += ap, ta1 -= ap) : (ta0 -= ap, ta1 += ap);
    ...
    /* src/MyChart.svelte generated by Svelte v3.59.2 */
    const file$1 = "src/MyChart.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			h1.textContent = "California TopoJSON with D3";
    			t1 = space();
    			div = element("div");
    			add_location(h1, file$1, 70, 0, 2022);
    			attr_dev(div, "id", "map");
    			add_location(div, file$1, 71, 0, 2059);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	validate_slots('MyChart', slots, []);
    	let width = 650;
    	let height = 600;
    	let projection = geoMercator().scale(1000 * 2).center([-120, 36]).translate([width / 2, height / 2]);
    	let path = geoPath().projection(projection);

    	onMount(() => {
    		const svg = select("#map").append("svg").attr("width", width).attr("height", height);
    		svg.append("path").datum(feature(cal, cal.objects.subunits)).attr("class", "land").attr("d", path);
    		const div = select("#map").append("div").attr("class", "tooltip").style("opacity", 0);

    		svg.selectAll(".subunit").data(feature(cal, cal.objects.subunits).features).enter().append("path").attr("class", d => "subunit " + d.properties.name).attr("d", path).on("mouseover", function (event, d) {
    			div.transition().duration(200).style("opacity", .9);
    			div.html(d.properties.fullName).style("left", event.pageX + 10 + "px").style("top", event.pageY - 30 + "px");
    		}).on("mouseout", function () {
    			div.transition().duration(500).style("opacity", 0);
    		});

    		svg.append("path").datum(mesh(cal, cal.objects.subunits, (a, b) => a === b)).attr("class", "exterior-boundary").attr("d", path);
    	});

    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<MyChart> was created with unknown prop '${key}'`);
    	});
    ...
    class MyChart extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_fragment(ctx) {
    	...
    	let mychart;
    	let current;
    	mychart = new MyChart({ $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			create_component(mychart.$$.fragment);
    			add_location(h1, file, 5, 1, 74);
    			add_location(div, file, 4, 2, 67);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(div, h1);
    			append_dev(div, t1);
    			mount_component(mychart, div, null);
    			current = true;
    		},
    		p: noop$4,
    		i: function intro(local) {
    			if (current) return;
    			transition_in(mychart.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(mychart.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    			destroy_component(mychart);
    		}
    	};
